...
export const Hero: React.FC = () => {
    ...
    useEffect(() => {
        // FIX: Agregamos un ligero retraso de 100ms. 
        // Esto obliga a React a pintar el estado inicial (invisible) antes de iniciar la transición.
        ...
        <section className="relative w-full h-[100dvh] flex items-center justify-center overflow-hidden">
            ...
            <div className="absolute inset-0 z-0 bg-ink">
                <img
                    ...
                    // Sustituimos ease-out por nuestra nueva variable ease-luxury
            ...
            <div className="relative z-20 container mx-auto px-6 md:px-12 flex flex-col items-center justify-center text-center">
                ...
                {/* Animación en cascada con ease-luxury */}
