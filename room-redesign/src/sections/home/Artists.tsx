...
const artistsData = [
    ...
    },
    {
        id: '02',
        name: 'Aris Thorne',
        category: 'Neo-Classical Sculpture',
        img: '/images/IMG_6892.webp',
    },
    {
        id: '03',
        name: 'Elena Volkov',
        category: 'Contemporary Curation',
...
export const Artists: React.FC = () => {
    ...
    // Estado y Referencia para el Intersection Observer (Animaciones de Scroll)
        ...
        >
            <div className="container mx-auto px-6 md:px-12">
                ...
                <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 relative">
                    ...
                    {/* Columna Izquierda: Lista interactiva de nombres (Animada en cascada) */}
                    <div className="w-full lg:w-1/2 flex flex-col justify-center">
                        {artistsData.map((artist, index) => (
                            <div
                                key={artist.id}
                                onMouseEnter={() => setActiveArtist(artist)}
                                // Animación de entrada al hacer scroll con delay escalonado
                    ...
                    {/* Columna Derecha: Imagen dinámica animada */}
                    <div
                    ...
                    >
                        {artistsData.map((artist) => (
                            <img
                                ...
                                /* Curva Bezier para que el cambio de foto se sienta como un deslizamiento sedoso */
                        ...
                        {/* Marco interior sutil para darle aspecto de lienzo */}
